...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=062225";?>" type="text/css" />
<?php
$isfw = false;
...
<script type="text/javascript" src="<?php echo $staticroot;?>/javascript/general.js?v=053025"></script>
<?php
//$_SESSION['mathdisp'] = 3;
//
if (isset($CFG['locale'])) {
