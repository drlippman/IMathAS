...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=060126";?>" type="text/css">
<?php
$isfw = false;
...
if (isset($_SESSION['graphdisp']) && $_SESSION['graphdisp']==1) {
	echo "<script src=\"$staticroot/javascript/ASCIIsvg}_min.js?v=062526\"></script>\n";
