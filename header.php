...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=081025c";?>" type="text/css" />
<?php
$isfw = false;
...
<script type="text/javascript" src="<?php echo $staticroot;?>/javascript/general.js?v=082725"></script>
<?php
//$_SESSION['mathdisp'] = 3;
//
if (isset($CFG['locale'])) {
...
echo "<script src=\"$staticroot/javascript/mathparser_min.js?v=082525\" type=\"text/javascript\"></script>\n";
if (isset($_SESSION['graphdisp']) && $_SESSION['graphdisp']==1) {
	echo "<script src=\"$staticroot/javascript/ASCIIsvg_min.js?ver=081925\" type=\"text/javascript\"></script>\n";
