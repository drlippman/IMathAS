...
<link rel="stylesheet" href="<?php echo $imasroot . "/imascore.css?ver=091916";?>" type="text/css" />
...
if (isset($sessiondata['graphdisp']) && $sessiondata['graphdisp']==1) {
	echo "<script src=\"$imasroot/javascript/ASCIIsvg_min.js?ver=102216\" type=\"text/javascript\"></script>\n";
