...
class MoleculeAnswerBox implements AnswerBox
{
    ...
    public function generate(): void
    {
        ...
        if ($_SESSION['userprefs']['drawentry'] == 0 || $forcea11y) { //accessible entry
            ...
            $out .= '<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/kekule@0.9.7/dist/kekule.min.js?module=chemWidget,IO"></script>';
            $out .= '<script type="text/javascript">
                if (!$("link[href=\'https://cdn.jsdelivr.net/npm/kekule@0.9.7/dist/themes/default/kekule.css\']").length) {
                    $(\'<link href="https://cdn.jsdelivr.net/npm/kekule@0.9.7/dist/themes/default/kekule.css" rel="stylesheet">\').appendTo("head");
                }
            </script>';
