...
<script defer="defer" type="module" src="<?php echo $staticroot;?>/assess2/vue/js/index.js?v=BepQf95i"></script>
<script defer="defer" nomodule src="<?php echo $staticroot;?>/assess2/vue/js/index-legacy.js?v=DnK3EKkl"></script>
