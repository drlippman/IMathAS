...
<form name="myForm" action="roster-message" method="post" id="roster-form">
    <div class="student-roster-message col-md-12 col-sm-12 padding-left-zero padding-right-zero">
        ...
        <div class="col-md-12 col-sm-12 padding-left-zero margin-top-twenty padding-right-zero">
            ...
            <?php echo "<div class='left col-md-10 col-sm-10'>
            <div class= 'editor message-message-textarea'>
    ...
    <div class="col-md-10 col-sm-10 col-md-offset-2 col-sm-offset-2 margin-top-ten padding-left-ten padding-right-zero">
    ...
    <div class="col-md-12 col-sm-12 padding-right-zero">
        <div class="col-md-2 col-sm-2 form-content"><b><?php AppUtility::t('Send copy to')?></b>
        </div>
        <div class="col-md-10 col-sm-10 form-content margin-left-zero">
            <span class="col-md-12 col-sm-12 padding-left-zero"><input type="radio" name="messageCopyToSend" id="self" value="onlyStudents"><span class="margin-left-five"> <?php AppUtility::t('Only Students')?></span></span>
            <span class="col-md-12 col-sm-12 padding-left-zero margin-top-five"><input type="radio" name="messageCopyToSend" id="self" value="selfAndStudents" checked="checked"><span class="margin-left-five"> <?php AppUtility::t('Students and you')?></span></span>
            <span class="col-md-12 col-sm-12 padding-left-zero margin-top-five"><input type="radio" name="messageCopyToSend" id="self" value="teachersAndStudents"><span class="margin-left-five"> <?php AppUtility::t('Students and all instructors of this course')?></span></span>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 margin-top-five padding-right-zero">

        <div class="col-md-offset-2 col-md-10 col-sm-offset-2 col-sm-10 form-content">
            <input type="checkbox" name="isChecked" id="save-sent-message" checked="true">
            <b class="padding-left-pt-five-em"><?php AppUtility::t('Save sent messages?')?></b>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 padding-right-zero">
        <div class="col-md-2 col-sm-2 margin-top-twenty-five padding-left-zero"><b><?php AppUtility::t('Limit send ')?></b></div>
        <div class="col-md-8 col-sm-8 roster-assessment form-content">
            <span class="select-text-margin form-content floatleft"><?php AppUtility::t('To students who haven\'t completed')?></span>
            <span class="form-content col-md-5 col-sm-5 margin-left-ten">
    ...
    <div class="col-md-offset-2 col-md-10 col-sm-offset-2 col-sm-10 padding-zero margin-top-twenty">
        <div class="col-md-12 col-sm-12 padding-left-ten"><input type="submit" class="btn btn-primary " id="message-button" value="<?php AppUtility::t('Send Message')?>">
    ...
    <div class="col-md-12 col-sm-12 padding-left-zero margin-top-fifteen">
        <div><span class="col-md-12 col-sm-12"><?php AppUtility::t('Unless limited, message will be sent to:')?></span></div>
        <div class="col-md-10 col-sm-10 col-md-offset-2 col-sm-offset-2 form-content list"><?php foreach (unserialize($studentDetails) as $studentDetail) { ?>
