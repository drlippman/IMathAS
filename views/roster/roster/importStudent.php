...
<div class="inner-content col-md-12 col-sm-12">
        ...
        <?php echo $form->field($model, 'firstName')->textInput(['value' => '3']); ?>
        ...
        <?php echo $form->field($model, 'lastName')->textInput(['value' => '3']); ?>
        ...
        <?php echo $form->field($model, 'emailAddress')->textInput(['value' => '7']); ?>
