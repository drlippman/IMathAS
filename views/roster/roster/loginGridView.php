            ...
            <form method="post" id="form-id" action="login-grid-view?cid=<?php echo $course->id;?>">
                ...
                <div class="col-sm-12 col-md-12 padding-left-zero">
                    ...
                    <p><?php AppUtility::t('Showing Number of Logins');?> <?php echo "$starttime through $endtime";?></p>
                            ...
                            <?php  if ($end < $now)
                                  { ?>
                    <div class="col-md-4 padding-left-zero padding-bottom-one-em col-sm-6 pull-left select-text-margin">
                            ...
                            <?php }else{ ?>
                        <div class="col-md-2 padding-left-zero padding-bottom-one-em col-sm-3 pull-left select-text-margin">
                                <a href="<?php echo AppUtility::getURLFromHome('roster','roster/login-grid-view?cid='.$course->id.'&start='.($start-7*24*60*60));?>"><?php AppUtility::t('Show previous week')?>.</a> &nbsp;
                            <?php } ?>
                        </div>
                    <div class="padding-left-zero  col-md-8 col-sm-11">
