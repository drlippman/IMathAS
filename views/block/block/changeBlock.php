...
<div class="tab-content shadowBox">
    ...
    <div style="padding-top: 10px">
        <div class="col-md-1"><?php AppUtility::t('Check')?></div>
        <div class="col-md-4">
            <label class="col-md-2 non-bold"><a href="#" onclick="return chkAllNone('qform','checked[]',true)"><?php echo _('All');?></a></label>
            <label class="col-md-2 non-bold"><a href="#" onclick="return chkAllNone('qform','checked[]',false)"><?php echo _('None');?></a></label>
        </div>
    </div>
    <div class="clear-both"></div>

<ul class="nomark padding-left">
    <?php echo '<div class="col-md-10 padding-left-zero"><b>Block in this course are</b></div><br/>';
...
<table class="gb" id="opttable">
    ...
    <tr>
        ...
        <td class="r col-md-4"><?php AppUtility::t('Show')?></td>
        <td class="col-md-6">
