...
?>
    ...
    <div class="tab-content shadowBox non-nav-tab-item">
        <div class="name-of-item">
            <div class="col-md-2"><?php AppUtility::t('Name of Forum')?></div>
            <div class="col-md-10">
        ...
        <div class="editor-summary">
            <div class="col-md-2"><?php AppUtility::t('Description')?></div>
            <div class="col-md-10">
                <div class=editor>
        ...
        <div class="col-md-10">
            ...
            <label class="non-bold" style="padding-left: 80px"><input type=radio name="avail" value="2" <?php AssessmentUtility::writeHtmlChecked($defaultValue['avail'], AppConstant::NUMERIC_TWO); ?>onclick="toggleGBdetail1(false)"/><span class='padding-left'><?php AppUtility::t('Show Always')?></span>
                ...
                <BR class=form>
                    ...
                    <div class=col-md-2><?php AppUtility::t('Group forum?')?></div>
                        <div class=col-md-4>
                             <?php
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Allow anonymous posts')?></div>
                            <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Allow students to modify posts')?></div>
                            <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Allow students to delete own posts (if no replies)')?></div>
                            <div class=col-md-10>
                                <input type="checkbox" name="allow-students-to-delete-own-posts" value="4"<?php if ($defaultValue['allowDelete']) { echo "checked=1";}?>><br>
                            </div>
                    </div><br class=form>

                    <div class=col-md-2><?php AppUtility::t('Turn on "liking" posts')?></div>
                        <div class=col-md-10>
                            <input type="checkbox" name="like-post" value="8"<?php if ($defaultValue['allowLikes']) { echo "checked=1";}?>><br>
                        </div><br class=form>

                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Viewing before posting')?></div>
                        <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Get email notify of new posts')?></div>
                        <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Default display')?></div>
                            <div class=col-md-4>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Sort threads by')?></div>
                            <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Students can create new threads')?></div>
                        <div class="col-md-10">
                        ...
                        <div class="item-alignment">
                            <div class=col-md-2><?php AppUtility::t('Students can reply to posts')?></div>
                            <div class="col-md-10">
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Calendar icon')?></div>
                           <div class=col-md-10>
                 ...
                 <div class="item-alignment">
                    <div class=col-md-2><?php AppUtility::t('Count in gradebook?')?></div>
                    <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class="col-md-2"><?php AppUtility::t('Use Scoring Rubric')?></div>
                        <div class=col-md-4>
                    ...
                    <div class="item-alignment">
                        ...
                        <div class="item-alignment">
                       <div class=col-md-2><?php AppUtility::t('Forum Type')?></div>
                            <div class=col-md-10>
                    ...
                    <div class="item-alignment">
                        <div class=col-md-2><?php AppUtility::t('Categorize posts?')?></div>
                         <div class=col-md-6>
