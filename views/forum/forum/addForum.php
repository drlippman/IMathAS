...
<?php } ?>
    ...
    <div class="tab-content shadowBox non-nav-tab-item">
        ...
        <div class="col-lg-10">
            <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="avail" value="0" <?php AssessmentUtility::writeHtmlChecked($defaultValue['avail'],AppConstant::NUMERIC_ZERO);?> onclick="toggleGBdetail1(false)"/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Hide')?></td></div>
            <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="avail" value="1" <?php AssessmentUtility::writeHtmlChecked($defaultValue['avail'],AppConstant::NUMERIC_ONE);?> onclick="toggleGBdetail1(true)"/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Show by Dates')?></td></div>
            <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="avail" value="2" <?php AssessmentUtility::writeHtmlChecked($defaultValue['avail'], AppConstant::NUMERIC_TWO); ?>onclick="toggleGBdetail1(false)"/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Show Always')?></td></div>
        </div>
        </div>
                <!--Show by dates-->
                    <div id="datediv" <?php if ($defaultValue['avail']!= AppConstant::NUMERIC_ONE) { echo 'style="display:none;"';}?>>

                    <div class=col-lg-2><?php AppUtility::t('Available After')?></div>
                    <div class=col-lg-10>
                        <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="available-after" value="0" <?php if($defaultValue['startDate'] == 0 ){ echo "checked=1"; }?>/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Always until end date')?></td></div>
                        <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility pull-left label-visible'><td><input type=radio name="available-after" class="pull-left" value="1" <?php if($defaultValue['startDate'] == 1 ){ echo "checked=1"; }?>/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td>
                        <?php
                    ...
                    <div class=col-lg-10>
                        <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="available-until" value="2000000000"  <?php if($defaultValue['endDate'] == 2000000000 ){ echo "checked=1"; }?>/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Always after start date')?></td></div>
                        <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility pull-left label-visible'><td><input type=radio name="available-until" class="pull-left value="1" <?php if($defaultValue['endDate'] == 1 ){ echo "checked=1"; }?>/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td>
                        <?php
                        echo '<div class = "col-lg-4 time-input" style="padding-left: 0">';
                        echo DatePicker::widget([
                            'name' => 'edate',
                ...
                <BR class=form>
                    ...
                    <div class="item-alignment">
                        <div class=col-lg-2><?php AppUtility::t('Allow anonymous posts')?></div>
                            <div class=col-lg-10>
                                <div class="checkbox override-hidden"><label class="inline-checkbox label-visible"><input type="checkbox" name="allow-anonymous-posts" value="1"<?php if ($defaultValue['allowAnonymous']) { echo "checked=1";}?> ><span class="cr"><i class="cr-icon fa fa-check"></i></span></label></div>
                            </div>
                    </div><br class=form>
                    ...
                    <div class="item-alignment">
                        <div class=col-lg-2><?php AppUtility::t('Allow students to modify posts')?></div>
                            <div class=col-lg-10>
                                <div class="checkbox override-hidden"><label class="inline-checkbox label-visible"><input type="checkbox" name="allow-students-to-modify-posts" value="2"<?php if ($defaultValue['allowModify']) { echo "checked=1";}?>><span class="cr"><i class="cr-icon fa fa-check"></i></span></label></div>
                        </div>
                    </div><br class=form>
                    ...
                    <div class="item-alignment">
                        <div class=col-lg-2><?php AppUtility::t('Allow students to delete own posts (if no replies)')?></div>
                            <div class=col-lg-10>
                                <div class="checkbox override-hidden"><label class="inline-checkbox label-visible"><input type="checkbox" name="allow-students-to-delete-own-posts" value="4"<?php if ($defaultValue['allowDelete']) { echo "checked=1";}?>><span class="cr"><i class="cr-icon fa fa-check"></i></span></label></div>
                        </div>
                    </div><br class=form>
                    ...
                    <div class="item-alignment">
                        ...
                        <div class="col-lg-10">
                            <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="post" value="2000000000" <?php if ($defaultValue['postBy']==2000000000) { echo "checked=1";}?>><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Always')?></td></div>
                            <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="post" value="0" <?php if ($defaultValue['postBy']==0) { echo "checked=1";}?>><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Never')?></td></div>
                            <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible pull-left'><td><input type=radio name="post" class="pull-left " value="1" <?php if ($defaultValue['postBy'] == 1) { echo "checked=1";}?> ><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td>
                            <?php
                        ...
                        <div class="item-alignment">
                            ...
                            <div class="col-lg-10">
                                <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="reply" value="2000000000" <?php if ($defaultValue['replyBy']==2000000000) { echo "checked=1";}?>><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Always')?></td></div>
                                <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="reply" value="0" <?php if ($defaultValue['replyBy']==0) { echo "checked=1";}?>><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Never')?></td></div>
                                <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible pull-left'><td><input type=radio name="reply" class="pull-left "value="1" <?php if ($defaultValue['replyBy'] == 1) { echo "checked=1";}?> ><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td>
                                <?php
                                echo '<label class="end pull-left">Before:</label>';
                                echo '<div class = "col-lg-4 time-input">';
                                echo DatePicker::widget([
                    ...
                    <div class="item-alignment">
                        <div class=col-lg-2><?php AppUtility::t('Calendar icon')?></div>
                           <div class=col-lg-10>
                        <?php AppUtility::t('New Threads')?><input type="text" name="calendar-icon-text1" value="<?php echo $defaultValue['postTag'];?>" size="2"> ,
                ...
                <div class="item-alignment">
                    ...
                    <div class="item-alignment">
                       <div class=col-lg-2><?php AppUtility::t('Forum Type')?></div>
                            <div class=col-lg-10>
                                <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="forum-type" value="0" <?php if ($defaultValue['forumType']==0) { echo 'checked=1';}?>/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t('Regular forum')?></td></div>
                                <div class='radio student-enroll visibility override-hidden'><label class='checkbox-size label-visibility label-visible'><td><input type=radio name="forum-type" value="1" <?php if ($defaultValue['forumType']==1) { echo 'checked=1';}?>/><span class='cr'><i class='cr-icon fa fa-check'></i></span></label></td><td><?php AppUtility::t(' File sharing forum')?></td></div>
                            </div><br class="form"/></div>

                    <div class="item-alignment">
                        <div class=col-lg-2><?php AppUtility::t('Categorize posts?')?></div>
                         <div class=col-lg-10>
                             <div class="checkbox override-hidden"><label class="inline-checkbox label-visible"><input type=checkbox name="categorize-posts" value="1" <?php if ($defaultValue['tagList'] != '') {echo "checked=1";} ?>onclick="document.getElementById('tagholder').style.display=this.checked?'':'none';"/><span class="cr"><i class="cr-icon fa fa-check"></i></span></label></div>

                              <span id="tagholder" style="display:<?php echo ($defaultValue['tagList'] == '') ? "none" : "inline"; ?>">
                              <?php AppUtility::t('Enter in format CategoryDescription:category,category,category')?><br/>
