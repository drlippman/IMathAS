...
<div class="replypost">
    ...
    <div>
        ...
        <div class="col-md-8"><input id="sub" class="textbox subject" type="text" value="Re:<?php echo $reply[0]['subject'] ?>">
        </div>
    </div>
    <br><br><br>
    <div>
    ...
    <div class="col-lg-offset-1 col-md-8">
        <br>
        <a class="btn btn-primary reply-btn" id="reply-btn">Post Reply</a>
    </div>
</div>
