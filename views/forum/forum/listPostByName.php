...
$this->params['breadcrumbs'][] = $this->title;
       ...
       {?>
            <div><h3>Post by Name- <?php echo $forumName->name ?></h3></div><br>
            ...
            {
                    if ($forumId == $data['forumIdData']){$count++;?>
                        ...
                        if ($name != $data['name']){?>
                            ...
                            <div class="block"><span class="right"><a
                                href='<?php echo AppUtility::getURLFromHome('forum', 'forum/post?courseid=' . $course->id . '&threadid=' . $data['threadId'] . '&forumid=' . $data['forumIdData']); ?>'>Thread</a>
                                ...
                                </span><input type="button" value="+" onclick="toggleshow(<?php echo $i ?>)"
                            ...
                            <div id="item<?php echo $i ?>" class="block-items"><p><?php echo $data['message'] ?></p></div>
                        </div>
                            <?php $name = $data['name'];
                        } else
                        {
