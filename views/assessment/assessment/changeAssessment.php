                ...
                <ul id="alistul" class=nomark>
                    ...
                    for ($i = 0; $i < (count($ids)); $i++) {
                        ...
                        if (strpos($types[$i], 'Block') !== false) {
                            ...
                            echo '<li>';
                            echo "<input type=checkbox name='checked[]' value='{$gTypeIds[$i]}' id='{$parents[$i]}.{$ids[$i]}:{$agbCats[$gTypeIds[$i]]}' checked=checked ";
                            echo '/>';
                            $pos = strrpos($types[$i], '-');
                            if ($pos !== false) {
            ...
            <table class="table table-bordered table-striped table-hover data-table " id="opttable">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <td>
                                ...
                                <div class="">
                                    <?php
                                    AssessmentUtility::writeHtmlSelect("summary", $pageAssessmentSelect['val'], $pageAssessmentSelect['label']);
                                    ?>
                                </div>
                            </td>
                        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <td>
                                <div class="pull-left"><?php AppUtility::t('Copy from:')?></div>
                                <?php
                                AssessmentUtility::writeHtmlSelect("intro", $pageAssessmentSelect['val'], $pageAssessmentSelect['label']);
                                ?>
                            </td>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <td>
                                <div class="pull-left"><?php AppUtility::t('Copy from:')?></div>
                                <?php
                                AssessmentUtility::writeHtmlSelect("dates", $pageAssessmentSelect['val'], $pageAssessmentSelect['label']);
                                ?>
                            </td>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <td style="border-bottom: 1px solid #000">
                                <div class="pull-left"><?php AppUtility::t('Copy from:')?></div>
                                <?php
                                AssessmentUtility::writeHtmlSelect("copyendmsg", $pageAssessmentSelect['val'], $pageAssessmentSelect['label']);
                                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <td>
                                <div class="pull-left"><?php AppUtility::t('Copy from:');?></div>
                                <?php
                                AssessmentUtility::writeHtmlSelect("copyopt", $pageAssessmentSelect['val'], $pageAssessmentSelect['label']);
                                ?>
                            </td>
                        </div>
                    </div>
                ...
                <tr class="coptr">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-4">
                            <td class="text-align"><?php AppUtility::t('Default attempts per problem (0 for unlimited):');?></td>
                        </div>
                        <div class="col-lg-6">
                            <td>
 					...
 					<span id="showreattdiffver" class="<?php if ($testType != "Practice" && $testType != "Homework") {
                        echo AppUtility::t('show',false);
                    } else {
                        echo AppUtility::t('hidden',false);
                    } ?>">
 					<input type=checkbox
                           name="reattemptsdiffver" <?php AssessmentUtility::writeHtmlChecked($line['shuffle'] & AppConstant::NUMERIC_EIGHT, AppConstant::NUMERIC_EIGHT); ?> />
                        ...
                        <div class="col-lg-6">
                            <td><input type=text size=4 name=defpenalty style="margin-bottom: 4px"
                                ...
                                <select class="form-control" name="skippenalty" <?php if ($taken) {
                                    ...
                                    <option value="0" <?php if ($skippenalty == AppConstant::NUMERIC_ZERO) {
                                        echo "selected=1";
                                    } ?>><?php AppUtility::t('per missed attempt')?>
                                    </option>
                                    <option value="1" <?php if ($skippenalty == AppConstant::NUMERIC_ONE) {
                                        echo "selected=1";
                                    } ?>><?php AppUtility::t('per missed attempt, after 1')?>
                                    </option>
                                    <option value="2" <?php if ($skippenalty == AppConstant::NUMERIC_TWO) {
                                        echo "selected=1";
                                    } ?>><?php AppUtility::t('per missed attempt, after 2')?>
                                    </option>
                                    <option value="3" <?php if ($skippenalty == AppConstant::NUMERIC_THREE) {
                                        echo "selected=1";
                                    } ?>><?php AppUtility::t('per missed attempt, after 3')?>
                                    </option>
                                    <option value="4" <?php if ($skippenalty == AppConstant::NUMERIC_FOUR) {
                                        echo "selected=1";
                                    } ?>><?php AppUtility::t('per missed attempt, after 4')?>
                                    </option>
                                    <option value="5" <?php if ($skippenalty == AppConstant::NUMERIC_FIVE) {
                                        echo "selected=1";
                                    } ?>><?php AppUtility::t('per missed attempt, after 5')?>
                                    </option>
                                    <option value="6" <?php if ($skippenalty == AppConstant::NUMERIC_SIX) {
                                        echo "selected=1";
                ...
                <tr class="coptr">
					...
					<select class="form-control" name="showans">
                        <option value="V" <?php if ($showAnswer == "V") {
                            echo "SELECTED";
                        } ?>><?php AppUtility::t('Never, but allow students to review their own answers')?>
                        </option>
                        <option value="N" <?php if ($showAnswer == "N") {
                            echo "SELECTED";
                        } ?>><?php AppUtility::t("Never, and don't allow students to review their own answers")?>
                        </option>
                        <option value="I" <?php if ($showAnswer == "I") {
                            echo "SELECTED";
                        } ?>><?php AppUtility::t("Immediately (in gradebook) - don't use if allowing multiple attempts per problem")?>
                        </option>
                        <option value="F" <?php if ($showAnswer == "F") {
                            echo "SELECTED";
                        } ?>><?php AppUtility::t('After last attempt (Skip Around only)')?>
                        </option>
                        <option value="A" <?php if ($showAnswer == "A") {
                            echo "SELECTED";
                        ...
                        <div class="col-lg-6">
                            <td>
                                <select class="form-control" name="eqnhelper">
                                    <option
                                        value="0" <?php AssessmentUtility::writeHtmlSelected($line['eqnhelper'],AppConstant::NUMERIC_ZERO) ?>>
                                        No
                                    </option>
                                    <?php
                                    //phase out unless a default
                                    if ($CFG['AMS']['eqnhelper'] == AppConstant::NUMERIC_ONE || $CFG['AMS']['eqnhelper'] == AppConstant::NUMERIC_TWO) {
                                        ?>
                                        <option
                                            value="1" <?php AssessmentUtility::writeHtmlSelected($line['eqnhelper'], AppConstant::NUMERIC_ONE) ?>>
                                            <?php AppUtility::t('Yes, simple form (no logs or trig)')?>
                                        </option>
                                        <option
                                            value="2" <?php AssessmentUtility::writeHtmlSelected($line['eqnhelper'], AppConstant::NUMERIC_TWO) ?>>
                        ...
                        <div class="col-lg-6">
                            <td>
                                <input type="checkbox"
                                       ...
                                       style="margin-bottom: 4px"/> <?php AppUtility::t('To forum')?> <?php AssessmentUtility::writeHtmlSelect("posttoforum", $$pageForumSelect['val'], $$pageForumSelect['label'], $line['posttoforum']); ?>
                            </td>
                        </div>
                    </div>
                </tr>
                ...
                <tr class="coptr">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <td>
                                <?php
                                AssessmentUtility::writeHtmlSelect("allowlate", $pageAllowLateSelect['val'], $pageAllowLateSelect['label'], 1);
                                ?>
