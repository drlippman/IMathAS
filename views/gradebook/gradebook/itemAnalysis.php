...
<div class="item-detail-header">
    ...
    if($student == AppConstant::NUMERIC_ZERO) {
      ...
      echo $this->render("../../itemHeader/_indexWithLeftContent",['link_title'=>['Home',$course->name,'View Scores'], 'link_url' => [AppUtility::getHomeURL().'site/index',AppUtility::getHomeURL().'course/course/course?cid='.$course->id,AppUtility::getHomeURL().'gradebook/gradebook/isolate-assessment-grade?cid='.$course->id.'&aid='.$assessmentId], 'page_title' => $this->title]);
    } else if ($from=='gisolate') {
      echo $this->render("../../itemHeader/_indexWithLeftContent",['link_title'=>['Home',$course->name,'View Group Scores'], 'link_url' => [AppUtility::getHomeURL().'site/index',AppUtility::getHomeURL().'course/course/course?cid='.$course->id,AppUtility::getHomeURL().'gradebook/gradebook/isolate-assessment-group?cid='.$course->id.'&aid='.$assessmentId], 'page_title' => $this->title]);
     } ?>
</div>
