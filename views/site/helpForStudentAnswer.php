...
<div class="site-about">
    ...
    <div class="content">
        ...
        <p class="ind">Enter fractions like 2/3 for <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/23.gif">. If not specified, the fraction
            does not need to be reduced, so <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/24.gif"> is considered the same as <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/12.gif">.</p>
        <p class="ind">
            For a reduced fraction answer, be sure to reduce your fraction to lowest terms.
            If <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/12.gif"> is the correct answer, <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/24.gif"> is not reduced, and would be marked wrong.</p>

        <p class="ind">For both fraction and reduced fraction type problems, improper
            fractions are OK, like <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/103.gif">, but mixed numbers will not be accepted.</p>

        <p class="ind">
            For a mixed number problem, enter your answer like 5_1/3 for <img src="<?php echo AppUtility::getHomeURL() ?>img/answerimgs/513.gif">. Improper
