...
?>
<h3><b>Modify Inline Text</b><img src="<?php echo AppUtility::getAssetURL() ?>img/help.gif"  alt="Help" onClick="window.open('<?php echo AppUtility::getHomeURL() ?>docs/help.php?section=inlinetextitems','help','top=0,width=400,height=500,scrollbars=1,left='+(screen.width-420))"/></h3>
<form enctype="multipart/form-data" method=post action="<?php echo AppUtility::getURLFromHome('course', 'course/modify-inline-text?id=' . $inline->id.'&courseId=') ?>">
    <span class=form>Title: </span>
	<span class=formright>
		<input type=text size=60 name=title value="<?php echo str_replace('"','&quot;',$inlineText['title']);?>"><br/>
		<input type="checkbox" name="hidetitle" value="1" />
		Hide title and icon
	</span><BR class=form>
    ...
    <div>
        ...
        echo htmlentities($inlineText['text']);?></textarea></div>
