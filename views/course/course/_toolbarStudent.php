...
?>
    <div class="common-navbar">
        <ul class="nav nav-tabs teacher-tab nav-justified nav-tabs-non-shadow" id="nav">
            ...
            <li class="active master-tabs"><a class="grey-color-link" href = "<?php echo AppUtility::getURLFromHome('course/course', 'index?cid='.$course->id); ?>"><img class="nav-course-icon" src="<?php echo AppUtility::getAssetURL()?>img/course.png"/><span class="margin-left-fifteen"><?php AppUtility::t('Course'); ?></span></a></li>
            <?php } else { ?>
            <li class="master-tabs"><a class="grey-color-link" href = "<?php echo AppUtility::getURLFromHome('course/course', 'index?cid='.$course->id); ?>"><img class="nav-course-icon" src="<?php echo AppUtility::getAssetURL()?>img/course.png"/><span class="margin-left-fifteen"><?php AppUtility::t(' Course'); ?></span></a></li>
            <?php } ?>
