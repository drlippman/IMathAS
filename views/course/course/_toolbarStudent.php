...
?>
    <div class="common-navbar">
        <ul class="nav nav-tabs teacher-tab nav-justified nav-tabs-non-shadow" id="nav">
            ...
            <li class="active master-tabs"><a class="grey-color-link" href = "<?php echo AppUtility::getURLFromHome('course/course', 'index?cid='.$course->id); ?>"><i class="fa fa-book icon-nav"></i><?php AppUtility::t('Course'); ?></a></li>
            <?php } else { ?>
            <li class="master-tabs"><a class="grey-color-link" href = "<?php echo AppUtility::getURLFromHome('course/course', 'index?cid='.$course->id); ?>"><i class="fa fa-book icon-nav"></i><?php AppUtility::t('Course'); ?></a></li>
            <?php } ?>
