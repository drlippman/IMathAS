...
<div class="tab-content shadowBox non-nav-tab-item">
    <div class="name-of-item">
        ...
        <div class="col-lg-10">
            <input class="input-item-title" type=text size=0 name=name
    ...
    <div id="fileinput" <?php if ($defaultValues['type'] != 'file')
    {
    	...
    	<span class="formright" style="margin-left: 14px;">
     ...
     <div id="toolinput" <?php if ($defaultValues['type'] != 'tool')
     {
        ...
        <div class="col-lg-4">
            ...
            if (count($toolvals) > 0)
            {
                ...
                echo '<br/>Custom parameters: <input type="text" name="toolcustom" size="40" value="' . htmlentities($defaultValues['toolcustom']) . '" /><br/><br>';
                echo 'Custom launch URL: <input type="text" name="toolcustomurl" size="40" value="' . htmlentities($defaultValues['toolcustomurl']) . '" /><br/>';
            } else {
    ...
    <div class=col-lg-10>
        <input type=radio name="open-page-in"
               value="0" <?php AssessmentUtility::writeHtmlChecked($defaultValues['open-page-in'], AppConstant::NUMERIC_ZERO); ?>  /><span
            class="padding-left"><?php AppUtility::t("Current window/tab") ?></span><br>
        <input type=radio name="open-page-in"
               value="1" <?php AssessmentUtility::writeHtmlChecked($defaultValues['open-page-in'], AppConstant::NUMERIC_ONE); ?>  /><span
            class="padding-left"><?php AppUtility::t("New window/tab") ?></span>
    </div>
    ...
    <div class=col-lg-10>
        <input type=radio name="avail" value="1"
               <?php AssessmentUtility::writeHtmlChecked($defaultValues['avail'], AppConstant::NUMERIC_ONE); ?>onclick="document.getElementById('datedivwithcalendar').style.display='block';document.getElementById('datediv').style.display='none';"/><span
        ...
        <label class="non-bold" style="padding-left: 80px"><input type=radio name="avail"
                                                                  value="0" <?php AssessmentUtility::writeHtmlChecked($defaultValues['avail'], AppConstant::NUMERIC_ZERO); ?>
                                                                  onclick="document.getElementById('datedivwithcalendar').style.display='none';document.getElementById('datediv').style.display='none';"/><span
                class="padding-left"><?php AppUtility::t("Hide") ?></span></label>
        <label class="non-bold" style="padding-left: 80px"><input type=radio name="avail"
                                                                  value="2" <?php AssessmentUtility::writeHtmlChecked($defaultValues['avail'], AppConstant::NUMERIC_TWO); ?>
                                                                  onclick="document.getElementById('datedivwithcalendar').style.display='none';document.getElementById('datediv').style.display='block';"/><span
    ...
    <div id="datedivwithcalendar"
        ...
        <div class=col-lg-10>
            ...
            <label class="pull-left non-bold" style="padding-left: 40px"><input type=radio name="available-after"
                                                                                class="pull-left"
                                                                                value="1" <?php if ($defaultValues['startDate'] == 1) {
                    echo 'checked=1';
                } ?>/></label>
            <?php
        ...
        <div class=col-lg-10>
            <label class="pull-left non-bold"><input type=radio name="available-until"
                                                     value="2000000000" <?php if ($defaultValues['endDate'] == AppConstant::ALWAYS_TIME) { echo 'checked=1';} ?>/><span
                    class="padding-left"><?php AppUtility::t("Always after start date") ?></span></label>
            <label class="pull-left" style="padding-left: 32px"><input type=radio name="available-until"
                                                                       class="pull-left"
                                                                       value="1"  <?php if ($defaultValues['endDate'] == 1) { echo 'checked=1'; } ?>/></label>
            <?php
            echo '<div class = "time-input pull-left col-lg-4">';
            echo DatePicker::widget([
                'name' => 'edate',
        ...
        <div class=col-lg-10>
            <input type=radio name="oncal"
                   value="0" <?php AssessmentUtility::writeHtmlChecked($defaultValues['calendar'], AppConstant::NUMERIC_ZERO); ?>  /><span
                class="padding-left"><?php AppUtility::t('No') ?></span><br>
            <input type=radio name="oncal"
                   value="1" <?php AssessmentUtility::writeHtmlChecked($defaultValues['calendar'], AppConstant::NUMERIC_ONE); ?>  /><span
                class="padding-left"><?php AppUtility::t('Yes, on Available after date (will only show after that date)') ?></span><br>
            <input type=radio name="oncal"
                   value="2" <?php AssessmentUtility::writeHtmlChecked($defaultValues['calendar'], AppConstant::NUMERIC_TWO); ?>  /><span
                class="padding-left"><?php AppUtility::t(' Yes, on Available until date') ?></span>
            <br><?php AppUtility::t('With tag') ?><span class="padding-left"><input type="text" size="3" value=<?php echo $defaultValues['caltag'];?>
                                                                                    name="tag"></span>
        </div>
        <br class="form"/><br>
    </div>
    ...
    <div id="datediv"
         style="display:<?php echo ($defaultValues['avail'] == AppConstant::NUMERIC_TWO) ? "block" : "none"; ?>">
        <div class=col-lg-2><?php AppUtility::t('Place on Calendar?') ?></div>
        <div class=col-lg-10>
            <input type=radio name="altoncal" value="0" <?php if ($defaultValues['altoncal'] == 0) {
                echo 'checked=1';
            } ?>  /><span class="padding-left"><?php AppUtility::t('No') ?></span><br>

            <div class=col-lg-10>
                <label class="pull-left" style="padding-left: 32px"><input type=radio name="altoncal" class="pull-left"
                                                                           value="1"  <?php if ($defaultValues['altoncal'] == 1) {
                        echo 'checked=1';
                    } ?>/></label>
                <?php
                echo '<div class = "time-input pull-left col-lg-4">';
    ...
    <br><br><p><sup>*</sup>Avoid quotes in the filename</p>
    <br class="form"/>
    <br>
</div>
<?php
