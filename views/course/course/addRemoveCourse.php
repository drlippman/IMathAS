...
<body>
        ...
        <div>
            ...
            <a class="btn btn-primary">Remove as Teacher </a>
        ...
        <div>
            <div class="lg-col-2 pull-left select-text-margin">
                <strong>With Selected:</strong> &nbsp;&nbsp;<a class="btn btn-primary">Add as Teacher </a>&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    function displayTeacher(teacher)
    {
        ...
        var teacherHtml = "";
        teacherHtml = "<tr><td><input type='checkbox'> </td> <td id='convertToUpper'>"+firstName+' '+lastName+"</td><td><a href='' class='addRemoveTeacher removeTeacherLink removeTeacher-"+teacher.id+"'>Remove as Teacher</a></td></tr>";
    ...
    function displayNonTeacher(nonTeacher)
    {
        ...
        var nonTeacherHtml = "";
        nonTeacherHtml = "<tr><td><input type='checkbox'> </td> <td id='convertToUpper'>"+firstName+' '+lastName+"</td><td><a href='' onclick='addTeacher("+nonTeacher.id+")' class='addRemoveTeacher addTeacherLink addTeacher-"+nonTeacher.id+"'>Add as Teacher</a></td></tr>";
