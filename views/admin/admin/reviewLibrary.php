...
<!--    <div id="headerreviewlibrary" class="pagetitle"><h2>Review Library</h2></div>-->
    ...
    <?php
        ...
        if ($source == AppConstant::NUMERIC_ZERO) {
            echo "	<p><a href=\"review-library?cid=$cid&offset=$offset&lib=$lib&source=1\">View/Modify Question Code</a></p>\n";
        } else {
            ?>
            <p>
            ...
            <form method=post action="review-library?cid=<?php echo $cid ?>&source=<?php echo $source ?>&offset=<?php echo $offset ?>&lib=<?php echo $lib ?>">
                ...
                <p>
                    ...
                    <a href="#" onclick="window.open('<?php echo AppUtility::getHomeURL()?>/assessment/libs/libhelp.php','Help','width=400,height=300,toolbar=1,scrollbars=1,resizable=1,status=1,top=20,left='+(screen.width-420))">Macro Library Help</a><BR>
                    Switch to:
