...
<script type="text/javascript">
    ...
    var curlibs = '<?php echo $searchlibs = 0 ?>';
    function libselect() {
...
<form id="pform" method=post action="export-question-set?cid=<?php echo $cid ?>">
    <br/><div class="col-lg-12"><h3><?php AppUtility::t('Questions Marked for Export')?></h3></div>
    <?php
    if (count($checked) == 0) {
        echo "<div class='col-lg-12'>No Questions currently marked for export</div>\n";
    } else {
        ?>
      <?php AppUtility::t('Check')?>
        ...
        <table cellpadding=5 class=gb>
            <thead>
            <tr>
                <th></th><th><?php AppUtility::t('Description')?></th><th><?php AppUtility::t('Type')?></th>
            </tr>
            </thead>
            <tbody>
            <?php
    ...
    <div class=col-lg-6><input type=text name="libname" size="40"/></div><br class=form>
...
<?php
    ...
    <div class="col-lg-12"><?php AppUtility::t('In Libraries')?><span id="libnames" class="padding-left-fifteen"><?php echo $lnames ?></span>
    ...
    <div class="col-lg-12"><?php AppUtility::t('Search')?><span class="padding-left-fifteen"><input type=text size=15 class="form-control-1" name=search value="<?php echo $search ?>"></span>
    <input type=submit value="Update and Search">
    <input type=submit name="finalize" value="Finalize"><BR></div>

    <?php
    if ($page_hasSearchResults == 0) {
        echo "<div class='col-lg-12'>No Questions matched search</div>\n";
    } else {
        ?>
        <?php AppUtility::t('Check')?>
        ...
        <table cellpadding=5 id=myTable class=gb>
            <thead>
            <tr><th></th><th><?php AppUtility::t('Description')?></th><th><?php AppUtility::t('Type')?></th></tr>
            </thead>
            <tbody>
    ...
    echo "<div class='col-lg-12'>Note: Export of questions with static image files is not yet supported</div>";
}
echo "</form>";
}
?>
