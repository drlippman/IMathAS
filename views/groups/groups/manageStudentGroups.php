...
<div class="tab-content shadowBox margin-top-two-em">
<div class="col-md-12 col-sm-12 group-background-div min-height-three-eighty">
    <br>
    <div class="col-md-12 col-sm-12 padding-left-two-em">
        ...
        <?php }elseif(isset($renameGrp)){?>
            ...
            <form method="post" action="<?php echo AppUtility::getURLFromHome('groups','groups/manage-student-groups?cid='.$course->id.'&grpSetId='.$grpSetId.'&renameGrp='.$renameGrp)?>">
                <div class="col-md-12 col-sm-12 padding-left-zero padding-top-one-pt-five-em">
                    <span class="floatleft padding-top-pt-five-em">New group name</span>
                    <span class="col-md-4 col-sm-4">
                        <input class="form-control-grp" name="grpname" type="text" value="<?php echo $currGrpName;?>"/>
                    </span>
                </div>
