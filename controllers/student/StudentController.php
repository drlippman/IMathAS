            ...
            if ($model->load(\Yii::$app->request->post())) {
                ...
                if ($course) {
                    ...
                    if (!$teacher && !$tutor && !$alreadyEnroll) {
                        ...
                        if ($teacher) {
                            $this->setErrorFlash('You are a teacher for this course, and can not enroll as a student.Use Student View to see the class from a student perspective, or create a dummy student account.');
                        } elseif ($tutor) {
                            $this->setErrorFlash('You are a tutor for this course, and can not enroll as a student.');
                        } else {
                            $this->setErrorFlash('You are already enrolled in the course.');
                        }
                    }
                } else {
