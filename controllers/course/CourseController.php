...
//    Display calendar on click of menuBars
    ...
    public function actionTimeShift()
    {
        ...
        if (isset($params['sdate'])) {
            ...
            $assissmentStartDate = $assessment['startdate'];
            //AppUtility::dump($assissmentStartDate);
            $assissmentEndDate = $assessment['enddate'];
            // AppUtility::dump($assissmentEndDate);


//
//                "SELECT startdate,enddate FROM imas_assessments WHERE id='{$_POST['aid']}'";
...
//            AppUtility::dump($assessmentData);
        ...
        return $this->render('timeShift', $responseData);
