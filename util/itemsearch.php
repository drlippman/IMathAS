...
echo '<form method="post"><p>Search: <input type="text" name="search" size="40" value="'.Sanitize::stripHtmlTags($_POST['search']).'"> <input type="submit" value="Search"/></p>';
if (isset($_POST['search'])) {
	echo '<p>';
	echo '<input type="submit" name="submit" value="Message"></p><p>';

	$srch = Sanitize::stripHtmlTags($_POST['search']);
