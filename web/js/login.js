...
function updateloginarea() {
    ...
    var html = "";
    html += '<div class="form-group"><label class="col-md-4 col-sm-2 control-label">Accessibility</label> <div class="col-md-8 col-sm-6"><select name="access" class="form-control"><option value="0">Use defaults</option>';
