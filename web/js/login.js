...
function updateloginarea() {
    ...
    html += "<div class='col-lg-1 help-link select-text-margin'><a href='#' onClick=\"window.open('helper-guide','help','top=0,width=400,height=500,scrollbars=1,left=150')\">Help</a> </div></div>";
