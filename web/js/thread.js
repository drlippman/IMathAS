        ...
        $.each(threads, function(index, thread)
        {
            ...
            if(fid == thread.forumiddata){
                if(thread.replyby == null)
                {
                    ...
                    html += "<tr> <td><a href='post?threadid=28'>" +(thread.subject) +"</a> "+ thread.name+" <a href='move-thread?forumId=2&courseId=2&threadId=7'>Move</a> <a href='modify-post?forumId=1&courseId=2&threadId=5'>Modify</a><a href='#'> Remove </a></td> ";
