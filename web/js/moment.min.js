...
(function(a)
{
    ...
    function B(b)
    {
        var c,d;if(0===b.indexOf("week"))c=7,d="day";
    else
    {
    ...
    function O(a)
    {
        ...
        for(b=0,c=d.length;c>b;b++)d[b]=rc[d[b]]?rc[d[b]]:N(d[b]);return function(e)
    {
        var f="";
        for(b=0;c>b;b++)f+=d[b]instanceof Function?d[b].call(e,a):d[b];return f
    }
    }
    function P(a,b)
    {
