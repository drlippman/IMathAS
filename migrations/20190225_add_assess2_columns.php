...
$query = "ALTER TABLE `imas_assessments`
 	...
 	ADD COLUMN showans ENUM('never','after_lastattempt','after_take','with_score','after_1','after_2','after_3','after_4','after_5','after_6','after_7','after_8','after_9') NOT NULL DEFAULT 'after_take',
 	ADD COLUMN viewingb ENUM('immediately', 'after_take', 'after_due', 'never') NOT NULL DEFAULT 'after_take',
 	ADD COLUMN scoresingb ENUM('in_gb', 'after_due', 'never') NOT NULL DEFAULT 'in_gb',
