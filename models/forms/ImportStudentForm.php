...
class ImportStudentForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['lastName'],'number','message' => 'Last name should contain only integer value'],
            [['firstName'],'number','message' => 'First name should contain only integer value'],
            [['emailAddress'],'number','message' => 'Email address should contain only integer value'],
