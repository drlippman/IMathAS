...
//    echo "<script type=\"text/javascript\" src=\"$imasroot"."js/general.js?ver=060414\"></script>\n";
    ...
    echo '<link rel="stylesheet" href="'.$imasroot.'css/handheld.css" media="handheld,only screen and (max-device-width:480px)"/>';
    if ($isdiag) {
