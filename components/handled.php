...
//        echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"$imasroot"."css/print.css?ver=".AppConstant::VERSION_NUMBER." media=\"print\"/>\n";
    ...
    if (!isset($sessiondata['mathdisp'])) {
        ...
        echo "<script src=\"$imasroot"."js/mathgraphcheck.js?ver=".AppConstant::VERSION_NUMBER." type=\"text/javascript\"></script>\n";
    } else if ($sessiondata['mathdisp']==1 || $sessiondata['mathdisp']==3) {
        echo '<script type="text/javascript">var AMTcgiloc = "'.$mathimgurl.'";</script>';
        echo "<script src=\"$imasroot"."js/ASCIIMathTeXImg_min.js?ver=".AppConstant::VERSION_NUMBER." type=\"text/javascript\"></script>\n";
    ...
    if ($sessiondata['graphdisp']==1) {
        echo "<script src=\"$imasroot"."js/ASCIIsvg_min.js?ver=".AppConstant::VERSION_NUMBER." type=\"text/javascript\"></script>\n";
        echo "<script type=\"text/javascript\">var usingASCIISvg = true;</script>";
    } else {
        echo "<script src=\"$imasroot"."js/mathjs.js?ver=".AppConstant::VERSION_NUMBER." type=\"text/javascript\"></script>\n";
...
<!--    <script type="text/javascript" src="--><?php //echo $imasroot;?><!--js/drawing_min.js?ver=--><?php //echo AppConstant::VERSION_NUMBER ?><!--"></script>-->
    ...
    if (isset($useeditor) && $sessiondata['useed']==1) {
        echo '<script type="text/javascript" src="'.$imasroot.'/editor/tiny_mce.js?ver='.AppConstant::VERSION_NUMBER.' "></script>';
        echo "\n";
