...
function diffeq_slopefield($func,$options=[]) {
    ...
    $out = "setBorder(10);initPicture($xmin,$xmax,$ymin,$ymax);axes($xlbl,$ylbl,$labels,$xgrid,$ygrid);stroke=\"blue\";fill=\"blue\";";
    if ($showarrows) {
        $out .= 'marker="arrow";';
    ...
    if ($doalt) {
		...
		return "<embed type='image/svg+xml' align='middle' width='$width' height='$height' script='$out' alt='Graph of slopefield; enable text alternatives in user preferences for more' />\n";
	}
