...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=062518" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/AMhelpers.js?v=062518" type="text/javascript"></script>';
