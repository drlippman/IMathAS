...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=111918" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/AMhelpers.js?v=111918" type="text/javascript"></script>';
