...
<link rel="stylesheet" href="<?php echo $imasroot . "/assessment/mathtest.css?ver=081718";?>" type="text/css"/>
<?php
...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=073018" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/AMhelpers.js?v=073018" type="text/javascript"></script>';
