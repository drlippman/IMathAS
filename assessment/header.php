...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=021919" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/AMhelpers.js?v=021919" type="text/javascript"></script>';
