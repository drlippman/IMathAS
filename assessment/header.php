...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=100718" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/AMhelpers.js?v=100718" type="text/javascript"></script>';
echo '<script src="' . $imasroot . '/javascript/confirmsubmit.js?v=031018" type="text/javascript"></script>';
echo '<script src="' . $imasroot . '/javascript/drawing.js?v=100518" type="text/javascript"></script>';
