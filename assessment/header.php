...
<![endif]--> 
<script src="<?php echo $imasroot . "/javascript/AMhelpers_min.js?v=021813";?>" type="text/javascript"></script>
<?php 
...
<script type="text/javascript" src="<?php echo $imasroot;?>/javascript/drawing_min.js?v=021313"></script>
<?php
