...
<link rel="stylesheet" href="<?php echo $imasroot . "/assessment/mathtest.css?ver=053014";?>" type="text/css"/>
...
if (!isset($sessiondata['mathdisp'])) {
	...
	echo "<script src=\"$imasroot/javascript/ASCIIMathTeXImg_min.js?v=020514\" type=\"text/javascript\"></script>\n";
...
<![endif]--> 
<script src="<?php echo $imasroot . "/javascript/AMhelpers_min.js?v=060214";?>" type="text/javascript"></script>
...
<script type="text/javascript" src="<?php echo $imasroot;?>/javascript/drawing_min.js?v=040514"></script>
<?php
