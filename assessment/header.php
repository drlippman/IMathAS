...
<link rel="stylesheet" href="<?php echo $imasroot . "/assessment/mathtest.css?ver=101909";?>" type="text/css"/>
<?php
echo "<script type=\"text/javascript\" src=\"$imasroot/javascript/general.js?ver=120109\"></script>\n";
...
tinyMCE.init({
    ...
    extended_valid_elements : 'img[longdesc|usemap|src|border|alt=|title|hspace|vspace|width|height|align|sscr]',
