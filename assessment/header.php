...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=102018" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/AMhelpers.js?v=101318" type="text/javascript"></script>';
echo '<script src="' . $imasroot . '/javascript/confirmsubmit.js?v=031018" type="text/javascript"></script>';
echo '<script src="' . $imasroot . '/javascript/drawing.js?v=102018" type="text/javascript"></script>';
