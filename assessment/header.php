...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=012819" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/drawing.js?v=012819" type="text/javascript"></script>';
