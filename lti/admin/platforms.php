...
echo '<li>'._('Addition Redirect URI:').' <span class=tocopy>'.$basesiteurl.'/bltilaunch.php</span></li>';
...
echo '<li>'._('For Redirect URIs, enter (with a new line between):').' <span class=tocopy>'.$basesiteurl.'/lti/launch.php'."\n".$basesiteurl.'/bltilaunch.php</span></li>';
/*
...
if ($bbclientid === false) {
  ...
  echo '<li>'._('Tool Redirect URLs:').' <span class=tocopy>'.$basesiteurl.'/lti/launch.php'."\n".$basesiteurl.'/bltilaunch.php</span></li>';
...
echo ' <li>'._('Add another Redirect URLs:').' <span class=tocopy>'.$basesiteurl.'/bltilaunch.php</span></li>';
...
echo ' <li>'._('Redirection URI(s), with a newline separating:').' <span class=tocopy>'.$basesiteurl.'/lti/launch.php'."\n".$basesiteurl.'/bltilaunch.php</span></li>';
