var AsciisvgDialog = {
	...
	insert : function() {
		...
		if (this.isnew) {
			...
			top.tinymce.activeEditor.execCommand('mceInsertContent', false, '<embed type="image/svg+xml" style="width:'+this.width+'px; height:'+this.height+'px; '+aligntxt+'" src="'+ this.AScgiloc + '?sscr='+encodeURIComponent(this.sscr)+'" sscr="'+this.sscr+'" script=" " />');
			top.tinymce.activeEditor.drawPics();
		} else {
