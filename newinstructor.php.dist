<?php
	...
	if (isset($_POST['firstname'])) {
		...
		if ($error != '') {
			...
			$stm->execute(array(':SID'=>$_POST['SID'], ':password'=>$pwhash, ':rights'=>12, ':FirstName'=>$_POST['firstname'], ':LastName'=>$_POST['lastname'], ':email'=>$_POST['email'], ':homelayout'=>$homelayout));
	...
	echo "<span class=form>First Name</span><span class=formright><input type=text id=firstname name=firstname value=\"$firstname\" autocomplete=\"given-name\" size=40></span><br class=form />\n";
	echo "<span class=form>Last Name</span><span class=formright><input type=text id=lastname name=lastname value=\"$lastname\" size=40 autocomplete=\"family-name\"></span><br class=form />\n";
	echo "<span class=form>Email Address</span><span class=formright><input type=text id=email name=email value=\"$email\" size=40 autocomplete=\"email\"></span><br class=form />\n";
	echo "<span class=form>Phone Number</span><span class=formright><input type=text id=phone name=phone value=\"$phone\" size=40 autocomplete=\"tel\"></span><br class=form />\n";
