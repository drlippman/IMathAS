...
tinymce.PluginManager.add('rollups', function(editor, url) {
    ...
    editor.ui.registry.addMenuButton('myEdit', {
        ...
        fetch: function(callback) {
            var items = "undo redo | cut copy paste pastetext | selectall | searchreplace";
            callback(items);
        }
    });
    ...
    editor.ui.registry.addMenuButton('myInsert', {
        text: 'Insert',
        fetch: function(callback) {
            var items = "media link image attach snippet inserttable accordion ableplayer | charmap emoticons anchor hr"
            callback(items);
        }
    });
