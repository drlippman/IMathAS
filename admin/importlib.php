...
if (!(isset($teacherid)) && $myrights<75) {
	...
	if ($isadmin || $isgrpadmin) {
		$curBreadcrumb = "<div class=breadcrumb><a href=\"../index.php\">Home</a> &gt; <a href=\"admin.php\">Admin</a> &gt; Import Libraries</div>\n";
	} else {
		$curBreadcrumb = "<div class=breadcrumb><a href=\"../index.php\">Home</a> &gt; <a href=\"../course/course.php?cid=$cid\">$coursename</a> &gt; Import Libraries</div>\n";
	}
	...
	if (isset($_POST['process'])) {
		...
		if ($isadmin || $isgrpadmin) {
			$page_uploadSuccessMsg .=  "<a href=\"http://" . $_SERVER['HTTP_HOST'] . rtrim(dirname($_SERVER['PHP_SELF']), '/\\') . "/admin.php\">Return to Admin page</a>";
		} else {
			$page_uploadSuccessMsg .= "<a href=\" http://" . $_SERVER['HTTP_HOST']  . $imasroot . "/course/course.php?cid=$cid\">Return to Course page</a>";
		}
