...
function initeditor(edmode,edids,css) {
	...
	var edsetup = {
	    ...
	    theme_advanced_buttons2 : "justifyleft,justifycenter,justifyright,justifyfull,separator,numlist,bullist,outdent,indent,separator,forecolor,backcolor,separator,hr,anchor,link,unlink,charmap,image,"+((fileBrowserCallBackFunc != null)?"attach,":"") + "table"+((document.documentElement.clientWidth<900 || coursetheme.match(/_fw/))?"":",tablecontrols,separator")+",code,separator,asciimath,asciimathcharmap,asciisvg",
