...
var tinyMCEPreInit = {base: imasroot+"/tinymce4", suffix: '.min'};
function initeditor(edmode,edids,css,inline,setupfunction){
	...
	var edsetup = {
		...
		toolbar2: " alignleft aligncenter alignright | bullist numlist outdent indent  | attach link unlink image | table | asciimath asciimathmq asciimathcharmap asciisvg",
