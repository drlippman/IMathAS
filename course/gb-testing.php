...
$placeinhead .= "document.getElementById(\"myTable\").className = \"gb\"; setCookie('gblhdr-$cid',0);";
...
$placeinhead .= "document.getElementById(\"myTable\").className = \"gbl\"; setCookie('gblhdr-$cid',1); ";
