...
?>
	...
	<form method="POST" action="deletedrillassess.php?cid=<?php echo Sanitize::courseId($_GET['cid']); ?>&block=<?php echo Sanitize::encodeStringForDisplay($block) ?>&id=<?php echo Sanitize::onlyInt($_GET['id']) ?>">
	<p>
