...
//  with Mods (c) David Lippman, 2005, for AsciiMath and AsciiSvg plugins
...
HTMLArea.prototype.generate = function () {
	...
	if (textarea.form) {
		...
		f.onsubmit = function() {
			...
			var newValue = editor.getHTML();
			//newValue = newValue.replace(/\xA0/g, ' '); //condenses double spaces
			editor._textArea.value = newValue;
...
HTMLArea.prototype._editorEvent = function(ev) {
	...
	if (keyEvent) {
		for (var i in editor.plugins) {
			var plugin = editor.plugins[i].instance;
			if (typeof plugin.onKeyPress == "function") plugin.onKeyPress(ev,editor); //editor var added by PJ
		}
	}
