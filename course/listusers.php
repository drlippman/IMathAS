...
?>			
				...
				<td><a href="exception.php?cid=<?php echo $cid ?>&uid=<?php echo $line['userid'] ?>">Exception</a></td>
...
?>
	...
	<div class=cp>
		...
		<a href="listusers.php?cid=<?php echo $cid ?>&assigncode=1">Assign Sections and/or Codes</a>
	</div>
