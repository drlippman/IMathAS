		   ...
		   if (is_array($items[$i])) { //if is a block
			...
			if ($items[$i]['avail']==2 || ($items[$i]['avail']==1 && $items[$i]['startdate']<$now && $items[$i]['enddate']>$now)) { //if "available"
				...
				if (strlen($items[$i]['SH'])>1 && $items[$i]['SH'][1]=='F') { //show as folder
					...
					echo "<b><a id=\"blockh{$items[$i]['id']}\" href=\"#blockh{$items[$i]['id']}\" onclick=\"return false;\" $astyle>{$items[$i]['name']}</a></b></span> ";
					if (isset($items[$i]['newflag']) && $items[$i]['newflag']==1) {
						echo "<span style=\"color:red;\">", _('New'), "</span>";
					}
					if ($viewall) { 
				...
				if (strlen($items[$i]['SH'])>1 && $items[$i]['SH'][1]=='F') { //show as folder
					...
					echo "<b>";
					if ($items[$i]['SH'][0]=='S') {
						echo "<a id=\"blockh{$items[$i]['id']}\" href=\"#blockh{$items[$i]['id']}\" onclick=\"return false;\" $astyle>{$items[$i]['name']}</a>";
					} else {
						echo "<i><a id=\"blockh{$items[$i]['id']}\" href=\"#blockh{$items[$i]['id']}\" onclick=\"return false;\" $astyle>{$items[$i]['name']}</a></i>";
					}
					echo "</b></span> ";
					if (isset($items[$i]['newflag']) && $items[$i]['newflag']==1) {
						echo "<span style=\"color:red;\">", _('New'), "</span>";
