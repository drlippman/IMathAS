...
if (!(isset($teacherid))) { // loaded by a NON-teacher
    ...
    $placeinhead .= "<script type=\"text/javascript\" src=\"$staticroot/javascript/addqsort2.js?v=102325\"></script>";
    $placeinhead .= "<script type=\"text/javascript\" src=\"$staticroot/javascript/qsearch.js?v=100825\"></script>";
    ...
    $placeinhead .= "<link rel=\"stylesheet\" href=\"$staticroot/course/addquestions2.css?v=080925\" type=\"text/css\" />";
    $placeinhead .= '<script>
        $(function() {
